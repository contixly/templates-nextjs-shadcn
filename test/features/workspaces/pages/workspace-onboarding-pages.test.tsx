...
jest.mock("@features/workspaces/actions/load-user-workspaces", () => ({
...
jest.mock("@features/application/components/home-cta-section", () => ({
  HomeCTASection: () => <div data-testid="home-cta-section" />,
}));

jest.mock("@features/application/template-landing-content", () => ({
...
jest.mock("@features/workspaces/components/user-workspaces", () => ({
  UserWorkspaces: ({
