...
export const HomeCTASection = ({ searchParams }: HomeCTASectionProps) => {
  ...
  return (
    <section className="flex flex-col items-center gap-6 px-6 py-16 text-center md:py-24">
      <h2 className="text-xl font-bold tracking-tight md:text-2xl">Ready to continue?</h2>
      <p className="text-muted-foreground max-w-md text-sm">
        The template is ready. Open the dashboard and adapt it to your own service.
      </p>
