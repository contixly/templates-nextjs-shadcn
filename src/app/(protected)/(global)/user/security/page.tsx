...
import { loadCurrentUserSessionList } from "@features/accounts/accounts-actions";
...
export default function SecurityPage() {
  const loadCurrentUserSessionsPromise = loadCurrentUserSessionList();

  return (
    <SettingsPageSection mode="readable">
      <UserSessions loadCurrentUserSessionsPromise={loadCurrentUserSessionsPromise} />
    </SettingsPageSection>
  );
}
